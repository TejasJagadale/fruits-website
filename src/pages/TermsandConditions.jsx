  ...
  return (
    <div>
      <div className="pageheadmain">
        <p className="pagehead">Terms And Conditions</p>
      </div>
      <div className="tcmain">
        <p>Last updated on Mar 23 2025</p>
        <p>
          For the purpose of these Terms and Conditions, The term “we”, “us”,
          “our” used anywhere on this page shall mean NALAM FRUITZ, whose
          registered/operational office is No 2 ,Varadharaja puram, west street
          , near dmart, Singanallur Singanallur TAMIL NADU 641015 . “you”,
        ...
        <ul className="tclist">
          ...
          <li>
            ...
            document without NALAM FRUITZ’s prior written consent.
          </li>
          <li>
